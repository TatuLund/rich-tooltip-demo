package com.example.tooltip.data.generator;

import com.example.tooltip.data.entity.SamplePerson;
import com.example.tooltip.data.service.SamplePersonRepository;
    ...
    public CommandLineRunner loadData(SamplePersonRepository samplePersonRepository) {
        return args -> {
            ...
            ExampleDataGenerator<SamplePerson> samplePersonRepositoryGenerator = new ExampleDataGenerator<>(
                    SamplePerson.class, LocalDateTime.of(2022, 4, 8, 0, 0, 0));
